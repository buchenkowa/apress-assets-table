...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_62__) {
...
exports.getCallback = exports.transformFromServer = exports.transformForServer = exports.block = exports.api = exports.unset = exports.has = exports.get = exports.isEqual = exports.cloneDeep = undefined;
...
var _bemCn = __webpack_require__(248);
...
var api = exports.api = _axios2.default.create({ baseURL: '' });
...
function handleChange(e) {
  ...
  this.setState((0, _defineProperty3.default)({}, e.target.id, value));
}
...
function swap(n, m, condition) {
  return condition === undefined || condition ? [m, n] : [n, m];
}

var transformForServer = exports.transformForServer = function transformForServer(records) {
  if (!records) {
    return [];
  }
...
var transformFromServer = exports.transformFromServer = function transformFromServer(record, templateRecord) {
  var newRecord = {};
...
var getCallback = exports.getCallback = function getCallback(callback, withCallback) {
  return withCallback ? callback : null;
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sagaHelpers__ = __webpack_require__(203);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__buffers__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scheduler__ = __webpack_require__(204);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var listCacheClear = __webpack_require__(334),
...
var HELP_LOAD_START = exports.HELP_LOAD_START = 'HELP_LOAD_START';
var HELP_LOAD_SUCCESS = exports.HELP_LOAD_SUCCESS = 'HELP_LOAD_SUCCESS';

var helpLoadStart = exports.helpLoadStart = function helpLoadStart(payload) {
  return {
    type: HELP_LOAD_START,
    payload: payload
  };
};
...
var baseIsTypedArray = __webpack_require__(314),
    ...
    nodeUtil = __webpack_require__(346);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__takeEvery__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__takeLatest__ = __webpack_require__(385);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__throttle__ = __webpack_require__(386);
...
var isFunction = __webpack_require__(164),
    isMasked = __webpack_require__(333),
    isObject = __webpack_require__(34),
...
var Symbol = __webpack_require__(79),
    ...
    equalArrays = __webpack_require__(160),
    mapToArray = __webpack_require__(344),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fsmIterator__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__io__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__io__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__buffers__ = __webpack_require__(88);
...
var _HelpItem = __webpack_require__(421);
...
var Help = function (_React$Component) {
  ...
  function Help() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Help.__proto__ || (0, _getPrototypeOf2.default)(Help)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      open: false,
      filter: ''
  ...
  (0, _createClass3.default)(Help, [{
    ...
    value: function render() {
      ...
      var regexp = new RegExp(this.state.filter, 'i');
      var list = this.props.help.filter(function (item) {
        return regexp.test(item.title);
      }).map(function (item) {
        return _react2.default.createElement(_HelpItem2.default, { key: item.id, title: item.title, content: item.content });
      });
      ...
      return _react2.default.createElement(
        'div',
        { className: b.is({ open: this.state.open }) },
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: b('search') },
            _react2.default.createElement(_Search2.default, { onChange: function onChange(value) {
...
var HelpItem = function (_React$Component) {
  (0, _inherits3.default)(HelpItem, _React$Component);
  ...
  function HelpItem() {
    ...
    (0, _classCallCheck3.default)(this, HelpItem);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = HelpItem.__proto__ || (0, _getPrototypeOf2.default)(HelpItem)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      open: false
    }, _this.handlerClick = function () {
      return _this.setState({ open: !_this.state.open });
    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  ...
  (0, _createClass3.default)(HelpItem, [{
    key: 'shouldComponentUpdate',
    value: function shouldComponentUpdate(nextProps, nextState) {
      return !(0, _isEqual3.default)(this.props, nextProps) || !(0, _isEqual3.default)(this.state, nextState);
    }
...
function help() {
  ...
  switch (action.type) {
    case _actions.HELP_LOAD_SUCCESS:
...
var _marked = [loadHelp].map(_regenerator2.default.mark);
...
var getHelp = function getHelp() {
  return _utils.api.get(app.config.help.url + '?' + objToParams(app.config.help.data)).then(function (response) {
...
function loadHelp() {
  var help;
  return _regenerator2.default.wrap(function loadHelp$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _effects.call)(getHelp);

        case 2:
          help = _context.sent;
          _context.next = 5;
          return (0, _effects.put)({ type: _actions.HELP_LOAD_SUCCESS, payload: help.hints });
...
var _Help = __webpack_require__(420);
